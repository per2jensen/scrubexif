...
- Topics not in some way meaningfully connected to the `scrubexif` project

## Scope

This Code of Conduct applies within all project spaces, including GitHub issues, pull requests, discussions, and any other interaction related to the `scrubexif` project.
